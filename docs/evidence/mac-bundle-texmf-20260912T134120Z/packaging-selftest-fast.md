# packaging-selftest.sh — 2026-09-12T13:42:57Z
...
- ok: make-app.sh --sign - --entitlements /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.ZEk0V7/missing.entitlements -> exit 1, pre-build, message: make-app.sh: --sign: entitlements file not found: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.ZE…
- ok: make-app.sh --sign - --entitlements /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.ZEk0V7/bad.entitlements -> exit 1, pre-build, message: make-app.sh: --sign: entitlements file is not a valid plist: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-…
...
- ok: bundle-texmf.py check apps/mac/Fonts/texmf: 7 entries verified against the pinned manifest
...
- ok: make-app.sh --debug -> exit 1, pre-build, message:       "status": "refused",           "path": "fonts/tfm/public/lm/ec-lmr10.tfm",           "status": "verified",        …
- ok: make-app.sh --debug -> exit 1, pre-build, message: make-app.sh: pinned bundle metrics root not found: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.Z…
