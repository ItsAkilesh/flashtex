# Typing bench: keystroke → paint latency (2026-09-12T094540Z)

Branch `agent/mac-claude-a/mac-shell` @ `af686a3`; Apple M1 Max; macOS 26.3.1; release build of `FlashTeXMac` (`swift build -c release`).
Script: `tools/typing-bench/run.sh`; raw JSON summaries in `typing-bench-2026-09-12T094540Z/`.

Producers:
- crates/compiler @ af686a3 (this checkout)
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| flashtex-preview-controller | body60k | 64103 | 0ms | 200 | 21 | 180 | 159 | 201 | 207 | 214 | 53 | 62 | 15 | 17 | 0 |
| flashtex-preview-controller | body60k | 64103 | 30ms | 200 | 54 | 147 | 191 | 262 | 273 | 288 | 72 | 98 | 5.6 | 17 | 0 |
| flashtex-preview-controller | demo | 6113 | 0ms | 200 | 104 | 97 | 53 | 67 | 69 | 69 | 21 | 26 | 8.8 | 10 | 0 |
| flashtex-preview-controller | demo | 6113 | 30ms | 200 | 187 | 14 | 53 | 77 | 84 | 94 | 26 | 34 | 4.2 | 12 | 0 |
| flashtex-preview-controller | fixture | 220 | 0ms | 200 | 175 | 25 | 40 | 54 | 59 | 61 | 13 | 15 | 11 | 14 | 0 |
| flashtex-preview-controller | fixture | 220 | 30ms | 200 | 200 | 0 | 39 | 50 | 58 | 62 | 13 | 16 | 14 | 15 | 0 |
