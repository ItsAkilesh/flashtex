# packaging-selftest.sh — 2026-09-12T18:02:19Z
...
- ok: make-app.sh --sign - --entitlements /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.8vIcEV/missing.entitlements -> exit 1, pre-build, message: make-app.sh: --sign: entitlements file not found: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.8v…
- ok: make-app.sh --sign - --entitlements /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.8vIcEV/bad.entitlements -> exit 1, pre-build, message: make-app.sh: --sign: entitlements file is not a valid plist: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-…
...
- ok: make-app.sh --debug -> exit 1, pre-build, message:       "status": "refused",           "path": "fonts/tfm/public/lm/ec-lmr10.tfm",           "status": "verified",        …
- ok: make-app.sh --debug -> exit 1, pre-build, message: make-app.sh: pinned bundle metrics root not found: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftest.8…

## Pinned Latin Modern faces (SUPPLEMENTARY-FACES.json; no build, no download, no host TeX)

- ok: bundle-texmf.py check apps/mac/Fonts/texmf apps/mac/Fonts: 19 supplementary faces + 3 Commander-pinned faces verified
- ok: all 22 producer-requestable Latin Modern faces present in apps/mac/Fonts
- ok: make-app.sh --debug -> exit 1, pre-build, message:       "status": "refused",           "path": "fonts/tfm/public/lm/ec-lmr10.tfm",           "status": "verified",        …
- ok: make-app.sh --debug -> exit 1, pre-build, message:       "status": "refused",           "path": "fonts/tfm/public/lm/ec-lmr10.tfm",           "status": "verified",        …
- ok: make-app.sh --debug -> exit 1, pre-build, message:       "status": "refused",           "path": "fonts/tfm/public/lm/ec-lmr10.tfm",           "status": "verified",        …
- ok: make-app.sh --debug -> exit 1, pre-build, message:       "status": "refused",           "path": "fonts/tfm/public/lm/ec-lmr10.tfm",           "status": "verified",        …
- ok: make-app.sh --debug -> exit 1, pre-build, message: make-app.sh: pinned bundle fonts directory not found: /var/folders/_0/d71mvr2d4_177qkm0506xl200000gn/T//flashtex-selftes…
