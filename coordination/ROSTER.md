...
| local-claude-opus | linux-primary | Claude Code Opus | Linux, substantial isolated implementation after login | claude-linux-max20x; saved tier metadata verified, execution auth absent | Registration/task preparation pending; blocked on login, no inference launched |
