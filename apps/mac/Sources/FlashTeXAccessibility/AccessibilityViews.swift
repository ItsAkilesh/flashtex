...
public struct AccessibilityHelpView: View {
    ...
    public static let voiceOverNotes: [String] = [
        "Sidebar: a list named by its sections; Project rows read “path, entry, bibliography, edited, active” and open includes read “path, not open, included from …; activate to open”; Outline rows read “section Title, line n”, “environment name, line n” or “label key, line n” inside Sections / Environments / Labels disclosure groups with their counts; Problems rows read “n errors” / “n warnings” / “All n” and show the Problems panel filtered.",
