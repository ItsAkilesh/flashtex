%% Oracle sample: apps/mac/Samples/demo.tex from origin/agent/mac-claude-a/mac-shell (4c6bf47).
%% Its leading comment line was replaced by these header lines and \documentclass was added; the body is verbatim.
