...
//!
//! 37-40 are the cumulative case: eight displays down one page whose box
...
//! gate). 40 is the same page *with* `lmodern`, which really does rebind
...
const PASSING: &[&str] = &[
    ...
    "36-cm-default-fonts",
    "37-cm-math-roman-boxes",
    "38-cm-math-roman-boxes-11pt",
    "39-cm-math-roman-boxes-12pt",
    "40-lm-math-roman-boxes",
];
