...
fn v1_items_are_positioned_exactly_where_v2_glyph_runs_start() {
    ...
    let v1 = v1_of(&r, Capabilities { rules: true, font_hints: true, display_list: false, images: false, device_color: false });
...
fn fraction_bars_are_explicit_rules_in_v2_and_negotiated_in_v1() {
    ...
    let typed = v1_of(&r, Capabilities { rules: true, font_hints: false, display_list: false, images: false, device_color: false });
