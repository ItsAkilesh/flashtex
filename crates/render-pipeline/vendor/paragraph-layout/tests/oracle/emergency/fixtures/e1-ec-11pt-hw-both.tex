...
Unless a problem explicitly says otherwise, every answer must be
...
recitation, provided that you identify the result you are using.\par}\showbox2
\setbox0=\vbox{\hsize=120pt \parindent=0pt \sloppy \tracingparagraphs=1 \tracingonline=0 %
