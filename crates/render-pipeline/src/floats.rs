                    ...
                    Piece::Graphic { span, options: opts, path: file } => {
                        ...
                        match images.load(options, file, page) {
                            Ok((resource, info)) => {
                                ...
                                parts.push(FloatPart::Graphic(PreparedGraphic { gbox: placed.gbox, resource: Some(resource), clip: placed.clip, span: *span }));
                            }
                            Err(msg) => {
                                ...
                                match (w, h) {
                                    (Some(w), Some(h)) => {
                                        ...
                                        parts.push(FloatPart::Graphic(PreparedGraphic { gbox, resource: None, clip: None, span: *span }));
                                    }
