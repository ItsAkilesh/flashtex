...
impl P<'_> {
        ...
        match name {
            ...
            "bibitem" => {
                ...
                if !in_bibliography {
                    ...
                    self.bib_cursor += 1;
                    if let Some((_, count, _, _)) = self.list_stack.last_mut() {
                        *count += 1;
                    }
        ...
        if kind == "begin" {
            ...
            if environment == "document" && self.has_document {
                ...
                let spacing = self
                    ...
                    .unwrap_or_default();
                self.list_stack
                    .push((environment.clone(), 0, Some(widest_label), spacing));
    ...
    fn flush_list_item(
        ...
        let widest_label = self.list_stack.last().and_then(|(kind, _, template, _)| {
