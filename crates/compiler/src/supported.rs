...
const TEXT_COMMANDS: &[(&str, &str, &str)] = &[
    ...
    ("nameref", "{key}", "title of the labelled section or caption, linked; starred form unlinked"),
    ...
    ("texorpdfstring", "{tex}{pdf}", "typesets tex; bookmarks use pdf"),
    ...
    ("tableautorefname", "", "hyperref name: Table"),
    ("theoremautorefname", "", "hyperref name: Theorem"),
    ...
    ("nocite", "{keys}", "no output; warns for undefined keys"),
...
const TEXT_ENVIRONMENTS: &[(&str, &str)] = &[
    ...
    ("table", "float body in place; \\caption numbers Table n"),
    (
        "NoHyper",
        "hyperref: references and links inside are typeset without links",
    ),
    ...
    ("minipage", "[t|c|b][height][t|c|b|s]{width}: vertical box of paragraphs in running text; footnotes are set inline"),
...
const PACKAGES: &[(&str, &str, &str)] = &[
    ...
    (
        "natbib",
        "numbers, super, authoryear, round, square, angle, curly, comma, semicolon, colon, sort, compress, sort&compress, longnamesfirst, sectionbib, openbib",
        "natbib citation commands, punctuation and bibliography labels",
    ),
    (
        "amsthm",
        "",
    ...
    (
        "hyperref",
        "colorlinks, bookmarksnumbered",
        "links, destinations, bookmarks and PDF info recorded for export; \\autoref, \\nameref, \\hypersetup",
    ),
    (
        "siunitx",
        "any \\sisetup keys",
...
pub const CANONICAL_SETS: &[&str] = &[
    "kernel", "amsmath", "amssymb", "enumitem", "geometry", "graphicx", "hyperref", "tikz", "xcolor", "siunitx",
];
