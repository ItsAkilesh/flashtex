...
const KNOWN_UNIMPLEMENTED_COMMANDS: &[&str] = &[
    ...
    "rVert", "varepsilon", "vartheta", "varphi", "varsigma", "varpi", "digamma",
    ...
    "prime",
    "backprime", "mathstrut", "not", "neq", "ne", "leq", "le", "geq", "ge", "ll", "gg",
    ...
    "bigotimes", "times", "div", "cdot", "circ", "ast", "pm", "mp", "sum",
    ...
    "hookleftarrow", "uparrow", "downarrow", "mid", "nmid", "parallel",
