...
const KNOWN_UNIMPLEMENTED_COMMANDS: &[&str] = &[
    ...
    "limits", "nolimits", "displaylimits", "vdots", "ddots", "iff", "implies", "impliedby",
    ...
    "varnothing", "nabla", "partial", "infty", "forall", "exists", "nexists", "top",
    ...
    "subseteq", "supseteq", "subsetneq", "supsetneq", "in", "ni", "notin", "cup", "cap",
    "setminus", "wedge", "vee", "oplus", "otimes",
    "odot", "times", "div", "cdot", "circ", "bullet", "star", "ast", "pm", "mp", "sum",
    "prod", "int", "oint", "to", "gets", "mapsto", "rightarrow", "leftarrow",
