...
\usepackage{fontspec}
\newfontfamily\lmr{lmroman10-regular.otf}
\pagestyle{empty}
...
\makeatother
\begin{document}
\noindent \lmr \kcprobe{}The quick brown fox jumps over the lazy dog.\par
\noindent \lmr ``Quoted'' text --- and -- dashes, `single' too.\par
\end{document}
