...
\makeatother
\begin{document}
\noindent \bfseries \kcprobe{}The quick brown fox jumps over the lazy dog.\par
\noindent \bfseries AVAST Wavy Toffee office, affine fjord flow.\par
\noindent \bfseries Typography: kerning Yo To LT WA pairs; fine.\par
\end{document}
