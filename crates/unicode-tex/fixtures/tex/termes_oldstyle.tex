...
\usepackage{fontspec}
\setmainfont{texgyretermes}[Extension=.otf,UprightFont=*-regular,BoldFont=*-bold,ItalicFont=*-italic,BoldItalicFont=*-bolditalic,Numbers=OldStyle]
\pagestyle{empty}
...
\makeatother
\begin{document}
\noindent \kcprobe{}Numbers 0123456789 and 2026, 1.5 or 42.\par
\noindent Office 3141 affluent 7 fjords.\par
\end{document}
