...
\makeatother
\begin{document}
\noindent \sffamily \kcprobe{}The quick brown fox jumps over the lazy dog.\par
\noindent \sffamily AVAST Wavy Toffee office, affine fjord flow.\par
\noindent \sffamily Typography: kerning Yo To LT WA pairs; fine.\par
\end{document}
