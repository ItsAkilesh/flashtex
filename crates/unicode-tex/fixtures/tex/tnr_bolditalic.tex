...
\makeatother
\begin{document}
\noindent \bfseries\itshape \kcprobe{}The quick brown fox jumps over the lazy dog.\par
\noindent \bfseries\itshape AVAST Wavy Toffee office, affine fjord flow.\par
\noindent \bfseries\itshape Typography: kerning Yo To LT WA pairs; fine.\par
\end{document}
