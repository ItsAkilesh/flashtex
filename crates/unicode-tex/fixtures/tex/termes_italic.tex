...
\makeatother
\begin{document}
\noindent \itshape \kcprobe{}The quick brown fox jumps over the lazy dog.\par
\noindent \itshape AVAST Wavy Toffee office, affine fjord flow.\par
\noindent \itshape Typography: kerning Yo To LT WA pairs; fine.\par
\end{document}
