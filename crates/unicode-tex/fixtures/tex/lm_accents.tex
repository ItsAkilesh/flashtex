...
\makeatother
\begin{document}
\noindent \kcprobe{}Café naïve résumé Zürich façade.\par
\noindent Ærøskøbing Øresund Łódź Šťastný ĳ.\par
\noindent Café naïve résumé done.\par
\noindent Zürich Å Å.\par
\end{document}
