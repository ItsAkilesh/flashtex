...
\makeatother
\begin{document}
\noindent \tnr \kcprobe{}The quick brown fox jumps over the lazy dog.\par
\noindent \tnr AVAST Wavy Toffee office, affine fjord flow.\par
\noindent \tnr Typography: kerning Yo To LT WA pairs; fine.\par
\noindent \tnr ``Quoted'' text --- and -- dashes, `single' too.\par
\noindent \tnr Guillemets <<ici>> and ,,low'' plus !`hola ?`que.\par
\noindent \tnr Straight "double" and it's done.\par
\end{document}
