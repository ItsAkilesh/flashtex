//! Public glyph-name tables needed to read a font's OWN glyph names:
//! the 391 CFF standard strings (CFF specification, Appendix A) that a CFF
//! charset refers to by SID, and the 258 Macintosh names a `post` format 2.0
//! table refers to by index. Data only; the readers live in
//! [`crate::tfm_binding`].
...
#[rustfmt::skip]
pub static MAC_GLYPH_NAMES: [&str; 258] = [
