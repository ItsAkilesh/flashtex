...
Generated 20260912T070234Z on mac-m1max-a by `tests/visual-corpus/harness/run.sh`.
...
|---|---|---|---|---|---|
| 01-stacked-fraction | math | DIFFERENT: 413/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `861254b0fe8b17a0…` |
| 02-sqrt-left-right | math | DIFFERENT: 773/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `46bef2965d96fdf2…` |
| 03-sum-limits-scripts | math | DIFFERENT: 549/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `15084a3d05ef44d6…` |
| 04-tall-braces | math | DIFFERENT: 944/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `ce22e3a2b7541f5b…` |
| 05-cube-root | math | DIFFERENT: 462/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `5949784f92e8aac5…` |
| 06-lim-sin | math | DIFFERENT: 935/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `1f34260c90acb758…` |
| 07-tall-sqrt-braces | math | DIFFERENT: 1687/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `2fa3a93fd09d9f65…` |
| 08-nested-scripts | math | DIFFERENT: 290/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `6d1307de434e0724…` |
| 09-int-display | math | DIFFERENT: 600/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `aff38fe95ae4d21c…` |
| 10-left-bracket-frac-squared | math | DIFFERENT: 489/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `4667029ffa9e603c…` |
| 11-accents | math | DIFFERENT: 395/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `4d4658da3488f60a…` |
| 12-sum-limits-inline | math | DIFFERENT: 480/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `abe692381c4f7893…` |
| 13-bigop-scripts-inline | math | DIFFERENT: 599/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `61a9d1dace36ae2c…` |
| 14-mixed-text-math | math | DIFFERENT: 1326/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `9163a9ba8e365467…` |
| 15-nested-fraction-sum | math | DIFFERENT: 766/1938816 px, max |Δ| 255 | unavailable | unpinned (no reference profile entry) | `825ecdd72de7d6a5…` |
...
- suite_branch: `mml-resume`
- suite_sha: `cdc21ff5d206b6c34c86c99e07d1ce7588602a56`
...
- compiler `math`: `HEAD (this checkout)` @ `cdc21ff5d206b6c34c86c99e07d1ce7588602a56` — declared-corpus lookup with rules-v1 + font-hints-v1 negotiated by a wrapper
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 01-stacked-fraction | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 01-stacked-fraction | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 02-sqrt-left-right | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 02-sqrt-left-right | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 03-sum-limits-scripts | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 03-sum-limits-scripts | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 04-tall-braces | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 04-tall-braces | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 05-cube-root | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 05-cube-root | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 06-lim-sin | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 06-lim-sin | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 07-tall-sqrt-braces | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 07-tall-sqrt-braces | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 08-nested-scripts | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 08-nested-scripts | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 09-int-display | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 09-int-display | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 10-left-bracket-frac-squared | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 10-left-bracket-frac-squared | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 11-accents | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 11-accents | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 12-sum-limits-inline | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 12-sum-limits-inline | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 13-bigop-scripts-inline | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 13-bigop-scripts-inline | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 14-mixed-text-math | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 14-mixed-text-math | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 15-nested-fraction-sum | pdflatex | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
| 15-nested-fraction-sum | pdflatex-lm | math | 0/1 | ok | - | - | - | - | - | -/-/- | - | - | - | - | -/- | - |
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 2 `re f` rectangles in the PDF (first: [74.391, 714.651, 4.498, 0.398] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 2 `re f` rectangles in the PDF (first: [81.963, 714.211, 6.652, 0.478] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 5 `re f` rectangles in the PDF (first: [84.563, 713.101, 4.034, 0.398] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 2 `re f` rectangles in the PDF (first: [82.295, 719.203, 8.536, 0.398] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 1 `re f` rectangles in the PDF (first: [92.657, 706.767, 23.017, 0.398] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 6 `re f` rectangles in the PDF (first: [82.516, 719.203, 29.16, 0.398] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 1 `re f` rectangles in the PDF (first: [78.454, 705.864, 6.145, 0.398] pt, PDF bottom-left origin)
...
- FlashTeX rule rectangles: 0 U+2500 items in compile_result, 2 `re f` rectangles in the PDF (first: [73.196, 706.4, 26.592, 0.398] pt, PDF bottom-left origin)
